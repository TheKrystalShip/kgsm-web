...
// Where the session comes from. A cluster signs people in at one place, so this names it.
function DoorwayChip({ anchor, verb, down, onOpen }) {
  if (!anchor) return null;
  const name = (anchor || "").replace(/^https?:\/\//, "");
  return (
    <button type="button" className="doorway" onClick={onOpen} title="Choose another cluster">
